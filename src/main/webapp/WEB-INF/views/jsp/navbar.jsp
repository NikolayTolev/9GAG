...
<div class="container-fluid">
	<div class="navbar-header">
		...
		<a class="navbar-brand"><span style="color: #AB0707"><b>FUN</b></span><span
			style="color: white"><i>FACTORY</i></span></a>
	</div>
			...
			<c:when test="${sessionScope.user != null}">
				<ul class="nav navbar-nav navbar-right">
					...
					<li><button id="uploadButton"
							class="btn btn-danger navbar-btn" onclick="openModelPost()">+ Upload</button></li>
				</ul>
						...
						<div class="upload-header">
							...
							<form method="post" action="upload/post" id="ajax-upload"
								...
								<table>
									...
									<tr style="text-align: left">
										<td>Description</td>
										<td><textarea name="description" rows="5" colls="16"
									...
									<tr style="text-align: left">
										<td>Section</td>
										<td><select style="width: 179px; height: 30px"
